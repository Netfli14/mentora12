...
export const QUESTIONS: Question[] = [
  ...
  // ---------- Делимость ----------
  {
    ...
    answer: ["1"],
    solution:
      "7 ≡ 2 (mod 5), значит 7¹⁰⁰ ≡ 2¹⁰⁰ = (2⁴)²⁵ = 16²⁵ ≡ 1²⁵ = 1 (mod 5). Остаток 1.",
    source: "Авторское задание Mentor AI",
    maxScore: 1,
  },
  {
  ...
  // ---------- Геометрия ----------
  {
    ...
    answer: ["4.8", "4,8", "24/5"],
    solution:
      "Гипотенуза = 10. Площадь = 6 · 8 / 2 = 24 = 10 · h / 2, откуда h = 4,8.",
    source: "Авторское задание Mentor AI",
    maxScore: 1,
  },
  {
  ...
  },
  {
    ...
    answer: ["84"],
    solution:
      "p = 21, по формуле Герона S = √(21 · 8 · 7 · 6) = √7056 = 84.",
    source: "Авторское задание Mentor AI",
    maxScore: 1,
  },
  ...
  },
  {
    ...
    solution:
      "1/(k(k+1)) = 1/k − 1/(k+1). Сумма телескопируется: 1 − 1/100 = 99/100.",
    source: "Авторское задание Mentor AI",
    maxScore: 1,
  },
  ...
  // ---------- Нестандартные ----------
  {
    ...
    answer: ["55"],
    solution:
      "Сумма всех чисел — инвариант: она не меняется при таком ходе. 1 + 2 + … + 10 = 55.",
    source: "Авторское задание Mentor AI",
    maxScore: 1,
  },
  {
